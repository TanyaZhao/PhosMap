...
- (4) kinase-substrate enrichment analysis to find activated/deactivated kinases from the kinase-substrate database
...
```{r visualization_line_chart_with_fuzzycluster, fig.cap = "Time course analysis example", fig.width = 6, fig.height = 6, fig.align = 'center'}
group_levels <- levels(group)
...
## Kinase-substrate enrichment analysis to find activated/deactivated kinases
In PhosMap, four Kinase-substrate enrichment analysis methods were included: KSEA, multiple linear regression (MLR) and Mean Value. 
- Data preparation
```{r }
...
- KSEA
```{r get_summary_df_list_from_ksea, fig.cap = "KSEA method", fig.width = 6, fig.height = 5, fig.align = 'center'}
system.time({
...
- Data preparation
```{r motif_get_aligned_sequence_df_based_on_fasta_library}
# *** foreground ***
...
```{r motif_enrichment_analysis_based_on_background}
...
```{r pheatmap, fig.cap = "Assign quantitative values of peptides to their motif",  fig.width = 6, fig.height = 5, fig.align = 'center'}
