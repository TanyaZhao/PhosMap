...
#  kinase_activity_df_mlr <- get_kinase_activity_using_mean_or_mlr(cluster_df, species = 'human', log2_label = TRUE, method = 'mlr')

## ----eval = FALSE--------------------------------------------------------
#  # get kinase activity matrix with mean value method
#  kinase_activity_df_mean <- get_kinase_activity_using_mean_or_mlr(cluster_df, species = 'human', log2_label = TRUE, method = 'mean')
