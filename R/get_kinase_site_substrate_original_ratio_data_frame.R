...
#' @examples
#' \dontrun{
#' kinase_site_substrate_original_ratio_df <- get_kinase_site_substrate_original_ratio_data_frame(
#'   ID,
...
get_kinase_site_substrate_original_ratio_data_frame <- function(
  ID,
  kinase_substrate_regulation_relationship,
  ksea_regulons,
  ptypes_data_ratio,
