...
#' @examples
#' \dontrun{
#' foreground_df_mapped_to_motifs <- get_foreground_df_mapped_to_motifs(
...
get_foreground_df_mapped_to_motifs <- function(foreground_sequences_mapped_to_motifs, foreground, foreground_df){
