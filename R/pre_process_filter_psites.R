...
pre_process_filter_psites <- function(firmiana_peptide_dir, psites_score_dir,
  ...
  result_list_from_PEPTIDE_DIR <- get_file_list_and_file_ID_from_specific_dir(PEPTIDE_DIR, phospho_experiment_ID)
  ...
  if(qc){
    ...
    result_list_from_PSITES_WITH_SCORE_DIR <- get_file_list_and_file_ID_from_specific_dir(PSITES_WITH_SCORE_DIR,
  ...
  merge_df_with_phospho_peptides <- get_merge_df_with_phospho_peptides(peptide.id,
