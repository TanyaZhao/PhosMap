...
#' @examples
#' \dontrun{
#' summry_list <- get_motif_analysis_summary_list(
#'   foreground,
#'   background,
#'   center,
#'   min_sequence_count,
...
get_motif_analysis_summary_list <- function(
  foreground,
  background,
  center='S',
  ...
  check_result_list <- check_foreground_and_background_and_center(foreground, background, center)
