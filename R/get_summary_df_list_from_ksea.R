...
get_summary_df_list_from_ksea <- function(
  ptypes_data,
  species = 'human',
  log2_label = TRUE,
  ratio_cutoff = 3
  ...
  ksea_regulons_regulation_direction_df <- get_ksea_regulons_information_dataframe(ksea_regulons, ksea_trans_list, ksea_trans_list,
                                                  ptypes_data_ratio_colnames)
  ksea_regulons_pvalue_df <- get_ksea_regulons_information_dataframe(ksea_regulons, ksea_trans_list, ksea_pvalue_list,
                                                   ptypes_data_ratio_colnames)
  ksea_regulons_activity_df <- get_ksea_regulons_information_dataframe(ksea_regulons, ksea_trans_list, ksea_activity_list,
                                                     ptypes_data_ratio_colnames)

  ksea_kinase_site_substrate_original_ratio_df <- get_kinase_site_substrate_original_ratio_data_frame(ID,
                                                      kinase_substrate_regulation_relationship,
                                                      ksea_regulons,
                                                      ptypes_data_ratio,
                                                      ratio_cutoff)
