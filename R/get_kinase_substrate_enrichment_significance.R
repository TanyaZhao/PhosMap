...
#' @examples
#' \dontrun{
#' pvalue <- get_kinase_substrate_enrichment_significance(
#'   substate_vector,
#'   regulons_of_kinase,
#'   1000
#' )
...
#'
#'
get_kinase_substrate_enrichment_significance <- function(
  substate_vector,
  regulons_of_kinase,
  trial = 1000
){
  ...
  expected_enrichment_score <- compute_kinase_substrate_enrichment_score(
    substate_vector,
    regulons_of_kinase,
  ...
  for(i in seq_len(trial)){
    ...
    stochastic_enrichment_score_i <- compute_kinase_substrate_enrichment_score(
      substate_vector,
